...
<html>
    ...
    <body>
        <main class="wrapper">
        <header>
            <h1><a href="index.php"><i class="logo fa <?=$logo?>"></i> Helene's Web Development Researches</a></h1>
        <nav id="cssmenu">
            <ul>
                <li><a href="../index.php"><span><i class="fa fa-fw fa-home"></i>IT 162</span></a></li>
                <li><a href="index.php"><span><i class="fa fa-fw fa-desktop"></i> BIG</span></a></li>
