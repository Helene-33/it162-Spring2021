...
<body>
	...
	<?php
        ...
        $toAddress = "helene.liobard@hotmail.com";  //place your/your client's email address here
        $toName = "Helene"; //place your client's name here
        $website = "ellencodes.com";  //place NAME of your client's website
